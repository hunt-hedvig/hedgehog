...
import ImageMessage from 'features/member/messages/ImageMessage'
import {
  ACTIVATION_DATE,
  AUDIO,
  BANK_ID_COLLECT,
  ...
  TEXT,
  VIDEO,
} from 'features/member/messages/message-types'
import SelectMessage from 'features/member/messages/SelectMessage'
