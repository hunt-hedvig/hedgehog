...
import {
  AssignVoucherNoDiscount,
  Scalars,
  useAssignCampaignToPartnerNoDiscountMutation,
} from 'types/generated/graphql'

interface NoDiscountFormData {
  code: string
...
const initialFormData: NoDiscountFormData = {
  code: '',
  partnerId: '',
  validFrom: null,
  validUntil: null,
...
const formIsValid = (formData: NoDiscountFormData) => {
            ...
            confirm(`Create new campaign code "${formData.code}"?`).then(() => {
              toast.promise(
                setPartnerNoDiscount({
                  variables: {
                    request: formData as AssignVoucherNoDiscount,
                  },
