...
export type QueryType = {
  ...
  SOSMemberLookup: SosMemberLookupResult
}
...
export type QueryTypeSosMemberLookupArgs = {
  ssn: Scalars['String']
}
...
export type SosMemberLookupQueryVariables = Exact<{
  ssn: Scalars['String']
}>
...
export type SharePathMutationOptions = ApolloReactCommon.BaseMutationOptions<
  ...
  SharePathMutationVariables
>
export const SosMemberLookupDocument = gql`
...
/**
 * __useSosMemberLookupQuery__
 *
 * To run a query within a React component, call `useSosMemberLookupQuery` and pass it any options that fit your needs.
 * When your component renders, `useSosMemberLookupQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSosMemberLookupQuery({
 *   variables: {
 *      ssn: // value for 'ssn'
 *   },
 * });
 */
export function useSosMemberLookupQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    SosMemberLookupQuery,
    SosMemberLookupQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SosMemberLookupQuery,
    SosMemberLookupQueryVariables
  >(SosMemberLookupDocument, options)
}
export function useSosMemberLookupLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SosMemberLookupQuery,
    SosMemberLookupQueryVariables
  >,
...
export type SosMemberLookupQueryHookResult = ReturnType<
  typeof useSosMemberLookupQuery
>
export type SosMemberLookupLazyQueryHookResult = ReturnType<
  typeof useSosMemberLookupLazyQuery
>
export type SosMemberLookupQueryResult = ApolloReactCommon.QueryResult<
  SosMemberLookupQuery,
  SosMemberLookupQueryVariables
>
